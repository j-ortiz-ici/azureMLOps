...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/project1-tests-ci.yml)
...
* [Staging workspace registered model](https://adb-xxxx.xx.azuredatabricks.net#mlflow/models/staging-project1-model)
* [Prod workspace registered model](https://adb-xxxx.xx.azuredatabricks.net#mlflow/models/prod-project1-model)
