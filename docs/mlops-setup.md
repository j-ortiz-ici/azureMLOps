...
[ML Config](../project1/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore project1/resources/README.md
...
- **`project1-tests-ci.yml`**:<br>
  - **[CI]** Performs unit and integration tests<br>
    - Triggered on PR to main
- **`project1-bundle-cicd.yml`**:<br>
  - **[CI]** Performs validation of Databricks resources defined under `project1/resources`<br>
...
```
git add .azure/devops-pipelines/project1-bundle-cicd.yml .azure/devops-pipelines/project1-tests-ci.yml 
...
1. Create two separate Azure Pipelines under your Azure DevOps project using the ‘Existing Azure Pipelines YAML file’ option. One of these pipelines will use the `project1-tests-ci.yml` script, and the other will use the `project1-bundles-cicd.yml` script. See [here](https://docs.microsoft.com/en-us/azure/devops/pipelines/create-first-pipeline) for more details on creating Azure Pipelines.
1. Create a new variable group called `project1 variable group` defining the following secret variables, for more details [here](https://learn.microsoft.com/en-us/azure/devops/pipelines/library/variable-groups?view=azure-devops&tabs=classic#create-a-variable-group):
...
5. Create two separate Azure Pipelines under your Azure DevOps project using the ‘Existing Azure Pipelines YAML file’ option. One of these Pipelines will use the `project1-tests-ci.yml` script, and the other will use the `project1-bundle-cicd.yml` script. See [here](https://docs.microsoft.com/en-us/azure/devops/pipelines/create-first-pipeline) for more details on creating Azure Pipelines.
...
Follow the instructions in [project1/resources/README.md](../project1/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../project1/resources/README.md)  to propose, test, and deploy
